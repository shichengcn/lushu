  ...
  },
  {
    ...
    stops: [
      ...
      seedStop({
        id: 'qg-sonamdajie',
        name: '索南达杰保护站',
        address: '玉树州治多县昆仑山区G109沿线',
        location: [93.601127, 35.431497],
        type: 'scenic',
        arrivalTime: '11:20',
        departureTime: '13:20',
        stayMinutes: 120,
        participantIds: BOTH,
        notes: [
          qingganNote('kekexili-rule', '只到合法开放的保护站，不驶入保护区腹地，不追逐野生动物。'),
          qingganNote('kekexili-altitude', '海拔接近4500米，如有明显高反立即返程。'),
        ],
        leg: createLeg('driving', 245, 250, {
          roadType: 'national',
          signal: 'none',
